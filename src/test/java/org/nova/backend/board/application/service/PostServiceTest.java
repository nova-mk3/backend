...
class PostServiceTest {
    ...
    void setUp() {
        ...
        postService = new PostService(postPersistencePort, fileService);
    ...
    void createPost() {
        ...
        // when
        Post savedPost = postService.createPost(samplePost, mockFiles);
    ...
    void createPostFailure() {
        ...
        // when & then
        assertThrows(FileDomainException.class, () -> postService.createPost(samplePost, mockFiles));
